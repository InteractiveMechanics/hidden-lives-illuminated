<?php 
	...
	$page_title		= "Schedule for Mon. Sept. 9";
	$page_id		= 1;
	...
	<div class="row">
		<div class="col-sm-12 col-md-8 offset-md-2 col-lg-6 offset-lg-3">
			<div class="page-content clearfix">
				...
				<h3>7:40 pm: Lightning Talk with Dan Haldeman</h3>
				<p>Local Professor Dan Haldeman will give a 20-minute presentation introducing restorative justice circles.</p>
				<div class="clearfix"></div><br/>
