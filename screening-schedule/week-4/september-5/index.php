<?php 
	...
	$page_title		= "Schedule for Thur. Sept. 5";
	$page_id		= 1;
	...
	<div class="row">
		<div class="col-sm-12 col-md-8 offset-md-2 col-lg-6 offset-lg-3">
			<div class="page-content clearfix">
				...
				<h3>7:00 – 9:00 pm: Pennsylvania Board of Probation and Parole</h3>
				<p>Meet representatives from the <a href="https://www.pbpp.pa.gov/Pages/default.aspx" target="_blank">Pennsylvania Board of Probation and Parole</a>.</p>
				<div class="clearfix"></div><br/>
