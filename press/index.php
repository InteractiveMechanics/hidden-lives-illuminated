	...
	<div class="row">
		<div class="col-sm-12 col-md-8 offset-md-2 col-lg-6 offset-lg-3">
			<div class="page-content clearfix">
				...
				<br /><br />
				<div class="text-center">
					<h2 class="text-underline">Press Resources</h2>
				</div>
				<div class="clearfix"></div>
				...
				<a href="https://www.dropbox.com/sh/j3qbt5s81z2eb4j/AADgyVtGkrUZ8m6vOkLGBy9ha?dl=0"><h3>Press Releases</h3></a>
				...
				<br /><br />
				<img src="<?php echo $base_path; ?>assets/press/hidden-lives-new-york-times.jpg" alt="A Former Prison Breaks From the System That Built It - The New York Times" class="float-left max-200" />
				...
				<img src="<?php echo $base_path; ?>assets/press/hidden-lives-comcast-newsmakers.jpg" alt="Hidden Lives Illuminated - Comcast Newsmakers" class="float-left max-200" />
